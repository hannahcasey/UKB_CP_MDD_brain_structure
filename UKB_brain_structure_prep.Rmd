...
```{r Load and format all UKB covariate and imaging data}
...
## Load in baseline characteristics - sex and age
...
UKB_assessment_centre_first_imaging$assessment_centre_first_imaging[UKB_assessment_centre_first_imaging$assessment_centre_first_imaging == 11027] <- "Newcastle"
UKB_assessment_centre_first_imaging$assessment_centre_first_imaging[UKB_assessment_centre_first_imaging$assessment_centre_first_imaging == 11025] <- "Cheadle"
UKB_assessment_centre_first_imaging$assessment_centre_first_imaging[UKB_assessment_centre_first_imaging$assessment_centre_first_imaging == 11026] <- "Reading"
UKB_assessment_centre_first_imaging$assessment_centre_first_imaging[UKB_assessment_centre_first_imaging$assessment_centre_first_imaging == 11028] <- "Bristol"
...
UKB_imaging_covariates <- left_join(UKB_BMI, UKB_sex_age, by = "f.eid")
UKB_imaging_covariates <- left_join(UKB_imaging_covariates, UKB_assessment_centre_first_imaging, by = "f.eid")
UKB_imaging_covariates <- left_join(UKB_imaging_covariates, UKB_imaging_ICV, by = "f.eid")
...
UKB_imaging_covariates$area_temporal_lobe <- UKB_imaging_covariates$f.26754.2.0 + UKB_imaging_covariates$f.26855.2.0 + UKB_imaging_covariates$f.26750.2.0 +
  ...
  UKB_imaging_covariates$f.26823.2.0 + UKB_imaging_covariates$f.26735.2.0 + UKB_imaging_covariates$f.26836.2.0 + UKB_imaging_covariates$f.26796.2.0 +
  UKB_imaging_covariates$f.26897.2.0 + UKB_imaging_covariates$f.26727.2.0 + UKB_imaging_covariates$f.26828.2.0 + UKB_imaging_covariates$f.26736.2.0 +
...
UKB_imaging_covariates$thickness_frontal_lobe <- UKB_imaging_covariates$f.26782.2.0 + UKB_imaging_covariates$f.26883.2.0 + UKB_imaging_covariates$f.26781.2.0 +
  UKB_imaging_covariates$f.26882.2.0 + UKB_imaging_covariates$f.26758.2.0 + UKB_imaging_covariates$f.26859.2.0 + UKB_imaging_covariates$f.26773.2.0 +
  UKB_imaging_covariates$f.26874.2.0 + UKB_imaging_covariates$f.26774.2.0 + UKB_imaging_covariates$f.26875.2.0 + UKB_imaging_covariates$f.26772.2.0 + 
  UKB_imaging_covariates$f.26873.2.0 + UKB_imaging_covariates$f.26786.2.0 + UKB_imaging_covariates$f.26887.2.0 + UKB_imaging_covariates$f.26766.2.0 +
  UKB_imaging_covariates$f.26867.2.0 + UKB_imaging_covariates$f.26768.2.0 + UKB_imaging_covariates$f.26869.2.0 + UKB_imaging_covariates$f.26778.2.0 + 
  UKB_imaging_covariates$f.26879.2.0 + UKB_imaging_covariates$f.26771.2.0 + UKB_imaging_covariates$f.26872.2.0
...
UKB_imaging_covariates$thickness_temporal_lobe <- UKB_imaging_covariates$f.26788.2.0 + UKB_imaging_covariates$f.26889.2.0 + UKB_imaging_covariates$f.26784.2.0 +
  UKB_imaging_covariates$f.26885.2.0 + UKB_imaging_covariates$f.26787.2.0 + UKB_imaging_covariates$f.26888.2.0 + UKB_imaging_covariates$f.26756.2.0 +
  UKB_imaging_covariates$f.26857.2.0 + UKB_imaging_covariates$f.26769.2.0 + UKB_imaging_covariates$f.26870.2.0 + UKB_imaging_covariates$f.26796.2.0 +
  UKB_imaging_covariates$f.26897.2.0 + UKB_imaging_covariates$f.26761.2.0 + UKB_imaging_covariates$f.26862.2.0 + UKB_imaging_covariates$f.26770.2.0 +
  UKB_imaging_covariates$f.26871.2.0 + UKB_imaging_covariates$f.26760.2.0 + UKB_imaging_covariates$f.26760.2.0
...
UKB_imaging_covariates$thickness_parietal_lobe <- UKB_imaging_covariates$f.26776.2.0 + UKB_imaging_covariates$f.26877.2.0 + UKB_imaging_covariates$f.26771.2.0 +
  UKB_imaging_covariates$f.26872.2.0 + UKB_imaging_covariates$f.26783.2.0 + UKB_imaging_covariates$f.26884.2.0 + UKB_imaging_covariates$f.26762.2.0 +
  UKB_imaging_covariates$f.26863.2.0 + UKB_imaging_covariates$f.26785.2.0 + UKB_imaging_covariates$f.26886.2.0 + UKB_imaging_covariates$f.26779.2.0 +
  UKB_imaging_covariates$f.26880.2.0
...
UKB_imaging_covariates$thickness_occipital_lobe <- UKB_imaging_covariates$f.26765.2.0 + UKB_imaging_covariates$f.26866.2.0 + UKB_imaging_covariates$f.26759.2.0 +
  UKB_imaging_covariates$f.26860.2.0 + UKB_imaging_covariates$f.26775.2.0 + UKB_imaging_covariates$f.26876.2.0 + UKB_imaging_covariates$f.26767.2.0 +
  UKB_imaging_covariates$f.26868.2.0
...
UKB_imaging_covariates$thickness_cingulate_lobe <- UKB_imaging_covariates$f.26780.2.0 + UKB_imaging_covariates$f.26881.2.0 + UKB_imaging_covariates$f.26757.2.0 +
  UKB_imaging_covariates$f.26858.2.0 + UKB_imaging_covariates$f.26777.2.0 + UKB_imaging_covariates$f.26878.2.0 + UKB_imaging_covariates$f.26764.2.0 +
  UKB_imaging_covariates$f.26865.2.0

## Sum lobar thicknesss to get global cortical thickness
UKB_imaging_covariates$thickness_global_cortical <- UKB_imaging_covariates$thickness_frontal_lobe + UKB_imaging_covariates$thickness_temporal_lobe + UKB_imaging_covariates$thickness_parietal_lobe +
  UKB_imaging_covariates$thickness_occipital_lobe +UKB_imaging_covariates$thickness_cingulate_lobe 
...
UKB_imaging_covariates_temp <- cbind(as.data.frame(UKB_imaging_covariates_temp[,"f.eid"]), PC_res_MD_association_fibres, PC_res_MD_thalamic_radiations, PC_res_MD_projection_fibres,
                                                             PC_res_MD_global)
...
## Add 1st PC to temporary dataframe
UKB_imaging_covariates_temp <- cbind(as.data.frame(UKB_imaging_covariates_temp$f.eid), PC_res_FA_association_fibres, PC_res_FA_thalamic_radiations, PC_res_FA_projection_fibres,
                                                  PC_res_FA_global)
...
## Remove outliers from across all brain structures
...
n_outliers
## 3075 brain strucutre measurements excluded in total
...
UKB_imaging_covariates[,all_brain_structure_names] <- as.data.frame(scale(UKB_imaging_covariates[,all_brain_structure_names]))

## Scale continuous covariates
UKB_imaging_covariates$ICV <- scale(UKB_imaging_covariates$ICV)
UKB_imaging_covariates$BMI <- scale(UKB_imaging_covariates$BMI)
UKB_imaging_covariates$age <- scale(UKB_imaging_covariates$age)
UKB_imaging_covariates$age_squared <- scale(UKB_imaging_covariates$age_squared)
```
...
UKB_inflammation_imaging_just_covariates <- UKB_imaging_covariates %>%
  select(f.eid, sex, age, age_squared, BMI, assessment_centre_first_imaging, ICV)
...
UKB_imaging_covariates_long <- bilateral_imag(imagnames = imaging_structures_bilateral_imagnames,
                                ...
                                covariates =  UKB_inflammation_imaging_just_covariates)
...
write.csv(UKB_imaging_covariates, "~/Desktop/PhD/projects/UKB_CP_MDD_brain_structure/resources/UKB_imaging_covariates.csv", quote = F)
