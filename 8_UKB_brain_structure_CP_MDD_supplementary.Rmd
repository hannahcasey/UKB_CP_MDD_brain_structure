...
res_CP_MDD_brain_structure$brain_structure_type  <- ordered(res_CP_MDD_brain_structure$brain_structure_type , levels = c("Regional Subcortical Volume", "Regional Cortical Volume","Global and Lobal Cortical Area", "Regional Cortical Area", "Cortical Area Global and Lobal Measures", "Regional Cortical Thickness","Global and Lobal Cortical Thickness", "Fractional Anisotropy", "Mean Diffusivity","General Fractional Anisotropy", "General Mean Diffusivity"))

res_disorder_interaction_brain_structure$brain_structure_type  <- ordered(res_disorder_interaction_brain_structure$brain_structure_type , levels = c("Regional Subcortical Volume", "Regional Cortical Volume","Global and Lobal Cortical Area", "Regional Cortical Area", "Cortical Area Global and Lobal Measures", "Regional Cortical Thickness","Global and Lobal Cortical Thickness", "Fractional Anisotropy", "Mean Diffusivity","General Fractional Anisotropy", "General Mean Diffusivity"))
...
cat_order <- c("Regional Subcortical Volume", "Regional Cortical Volume","Global and Lobal Cortical Area", "Regional Cortical Area", "Cortical Area Global and Lobal Measures", "Regional Cortical Thickness","Global and Lobal Cortical Thickness", "Fractional Anisotropy", "General Fractional Anisotropy", "Mean Diffusivity", "General Mean Diffusivity")
...
Supplementary Table 8 Full results for chronic pain interaction and sex-chronic pain interaction analysis between brain structure and depression in full, female and male sample. \*, \*\* and \*\*\* represent significant results at p~FDR~\<.05, p~FDR~\<.01 and p~FDR~\<.001, respectively (FDR correction not applied to p-values from sex-interaction analysis). Significant results are highlighted in bold.
