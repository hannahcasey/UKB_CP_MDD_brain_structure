...
## With comorbid chronic pain and depression
...
descriptives_df <- data.frame(
  Variables = c("Mean Age (SD)", "Chronic Pain (%)", "Depression (%)", "Comorbid Chronic Pain and Depression (%)"), 
  full_temp = c(
    paste0(age_mean_full, " (", age_sd_full, ")"), ## Age full sample
    paste0(chronic_pain_percent_full, "%"), ## Chronic pain full sample
    paste0(depression_percent_full,  "%"), ## Depression full sample
    paste0(comorbid_percent_full,  "%") ## Comorbidity in full sample
    ),
  female_temp = c(
    paste0(age_mean_female, " (", age_sd_female, ")"), ## Age female sample
    paste0(chronic_pain_percent_female, "%"), ## Chronic pain female sample
    paste0(depression_percent_female, "%"), ## Depression female sample
    paste0(comorbid_percent_female, "%") ## Comorbidity in female sample
    ),
  male_temp = c(
    paste0(age_mean_male, " (", age_sd_male, ")"), ## Age male sample
    paste0(chronic_pain_percent_male, "%"), ## Chronic pain male sample
    paste0(depression_percent_male, "%"), ## Depression male sample
    paste0(comorbid_percent_male, "%") ## Comorbidity in male sample
    ))
