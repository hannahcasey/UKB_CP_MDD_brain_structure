...
res_comorbidity_brain_structure_female_site <- read.csv("/Users/hannahcasey/Desktop/PhD/projects/UKB_CP_MDD_brain_structure/output/all_comorbidity_structure_assoc_females_site.csv",header=T)
res_comorbidity_brain_structure_female_site$sample <- "Female"

res_comorbidity_brain_structure_male_site <- read.csv("/Users/hannahcasey/Desktop/PhD/projects/UKB_CP_MDD_brain_structure/output/all_comorbidity_structure_assoc_males_site.csv",header=T)
res_comorbidity_brain_structure_male_site$sample <- "Male"
...
res_comorbidity_brain_structure_sex_site <- rbind(res_comorbidity_brain_structure_female_site, res_comorbidity_brain_structure_male_site)
...
res_comorbidity_brain_structure_sex_site$brain_phenotype_plot <-  gsub("MD", "MD in", res_comorbidity_brain_structure_sex_site$brain_phenotype)
res_comorbidity_brain_structure_sex_site$brain_phenotype_plot <- gsub("FA", "FA in", res_comorbidity_brain_structure_sex_site$brain_phenotype_plot)
res_comorbidity_brain_structure_sex_site$brain_phenotype_plot <- gsub("volume", "Volume of", res_comorbidity_brain_structure_sex_site$brain_phenotype_plot)
res_comorbidity_brain_structure_sex_site$brain_phenotype_plot <- gsub("area", "Area of", res_comorbidity_brain_structure_sex_site$brain_phenotype_plot)
res_comorbidity_brain_structure_sex_site$brain_phenotype_plot <- gsub("thickness", "Thickness of", res_comorbidity_brain_structure_sex_site$brain_phenotype_plot)
res_comorbidity_brain_structure_sex_site$brain_phenotype_plot <- gsub("sub_cortical_Volume", "Subcortical volume", res_comorbidity_brain_structure_sex_site$brain_phenotype_plot)
res_comorbidity_brain_structure_sex_site$brain_phenotype_plot <- gsub("\\.[1-9]", "", res_comorbidity_brain_structure_sex_site$brain_phenotype_plot)
res_comorbidity_brain_structure_sex_site$brain_phenotype_plot <-  gsub("_|[.]", " ", res_comorbidity_brain_structure_sex_site$brain_phenotype_plot)
...
res_CP_MDD_brain_structure_sex_site$brain_structure_type  <- ordered(res_CP_MDD_brain_structure_sex_site$brain_structure_type , levels = c("Subcortical Volumes", "Cortical Regional Volumes","Cortical Volume Global and Lobal Measures", "Cortical Regional Areas", "Cortical Area Global and Lobal Measures", "Cortical Regional Thickness","Cortical Thickness Global and Lobal Measures", "FA Tracts", "MD Tracts","FA General Measures", "MD General Measures"))
...
res_comorbidity_brain_structure_sex_site$brain_structure_type  <- ordered(res_comorbidity_brain_structure_sex_site$brain_structure_type , levels = c("Subcortical Volumes", "Cortical Regional Volumes","Cortical Volume Global and Lobal Measures", "Cortical Regional Areas", "Cortical Area Global and Lobal Measures", "Cortical Regional Thickness","Cortical Thickness Global and Lobal Measures", "FA Tracts", "MD Tracts","FA General Measures", "MD General Measures"))
...
res_CP_MDD_brain_structure_sex_site$`Adjusted p-value` = ifelse(res_CP_MDD_brain_structure_sex_site$p.adjust < 0.05, "Yes","No")
res_comorbidity_brain_structure$significant <- ifelse(res_comorbidity_brain_structure$p.adjust < 0.05,"Yes" , "No")
res_comorbidity_brain_structure_sex_site$significant <- ifelse(res_comorbidity_brain_structure_sex_site$p.adjust < 0.05,"Yes" , "No")
...
res_comorbidity_brain_structure_sex_site <- res_comorbidity_brain_structure_sex_site[res_comorbidity_brain_structure_sex_site$groups == "(No Probable Recurrent MDD + No Chronic Pain) - (No Probable Recurrent MDD + Chronic Pain)" | res_comorbidity_brain_structure_sex_site$groups == "(No Probable Recurrent MDD + No Chronic Pain) - (Probable Recurrent MDD + Chronic Pain)" | res_comorbidity_brain_structure_sex_site$groups == "(No Probable Recurrent MDD + No Chronic Pain) - (Probable Recurrent MDD + No Chronic Pain)",]
...
res_comorbidity_brain_structure_sex_site$groups[res_comorbidity_brain_structure_sex_site$groups == "(No Probable Recurrent MDD + No Chronic Pain) - (No Probable Recurrent MDD + Chronic Pain)"] <- "CP+MDD-"
res_comorbidity_brain_structure_sex_site$groups[res_comorbidity_brain_structure_sex_site$groups == "(No Probable Recurrent MDD + No Chronic Pain) - (Probable Recurrent MDD + No Chronic Pain)"] <- "CP-MDD+"
res_comorbidity_brain_structure_sex_site$groups[res_comorbidity_brain_structure_sex_site$groups == "(No Probable Recurrent MDD + No Chronic Pain) - (Probable Recurrent MDD + Chronic Pain)"] <- "CP+MDD+"
...
res_CP_MDD_brain_structure_sex_site$Direction <- ifelse(sign(res_CP_MDD_brain_structure_sex_site$beta) < 1,"Negative" , "Positive")
...
rm(res_CP_MDD_brain_structure_all)
rm(res_CP_MDD_brain_structure_female_site)
rm(res_CP_MDD_brain_structure_male_site)

rm(res_comorbidity_brain_structure_all)
rm(res_comorbidity_brain_structure_male)
rm(res_comorbidity_brain_structure_female)
rm(res_comorbidity_brain_structure_female_site)
rm(res_comorbidity_brain_structure_male_site)
...
## split up dataframe by disorder and sex
res_CP_MDD_brain_structure_female_CP_site <- res_CP_MDD_brain_structure_sex_site[res_CP_MDD_brain_structure_sex_site$disorder == "chronic_pain" & res_CP_MDD_brain_structure_sex_site$sample == "Female",]
res_CP_MDD_brain_structure_male_CP_site <- res_CP_MDD_brain_structure_sex_site[res_CP_MDD_brain_structure_sex_site$disorder == "chronic_pain" & res_CP_MDD_brain_structure_sex_site$sample == "Male",]

## Order levels of brain phenotpyes in oder of beta values to make plot neat
res_CP_MDD_brain_structure_female_CP_site$brain_phenotype_plot <- reorder(res_CP_MDD_brain_structure_female_CP_site$brain_phenotype_plot, -res_CP_MDD_brain_structure_female_CP_site$beta)
res_CP_MDD_brain_structure_male_CP_site$brain_phenotype_plot <- reorder(res_CP_MDD_brain_structure_male_CP_site$brain_phenotype_plot, -res_CP_MDD_brain_structure_male_CP_site$beta)

## Create discrete colour palette
pal1 <- wes_palette("Darjeeling1",3, type = "discrete")

## Plot resutls
brain_structure_gg = ggplot(res_CP_MDD_brain_structure_female_CP_site, aes(x=brain_phenotype_plot, y=beta, shape=`Adjusted p-value`,colour=site)) + 
  geom_point(aes(y=beta),size=3, alpha = 0.5) +
  geom_errorbar(aes(ymin=Lower_95CI, ymax=Upper_95CI), width=0, alpha = 0.5) +
  theme_minimal() +
  geom_hline(yintercept=0, linetype="dashed", color = "black") +
  ...
  labs(x = "", 
       y = "Standardised effect size", 
       title = "Chronic pain and brain structures in UK Biobank: site-stratified in female sample",
       colour = "Sex",
       shape = "Significance") +
  theme(plot.title = element_text(hjust = 0.5)) +
  scale_color_manual(values = pal1) +
...
brain_structure_gg = ggplot(res_CP_MDD_brain_structure_male_CP_site, aes(x=brain_phenotype_plot, y=beta, shape=`Adjusted p-value`,colour=site)) + 
  geom_point(aes(y=beta),size=3, alpha = 0.5) +
  geom_errorbar(aes(ymin=Lower_95CI, ymax=Upper_95CI), width=0, alpha = 0.5) +
  theme_minimal() +
  geom_hline(yintercept=0, linetype="dashed", color = "black") +
  ...
  labs(x = "", 
       y = "Standardised effect size", 
       title = "Chronic pain and brain structures in UK Biobank: site-stratified in male sample",
       colour = "Sex",
       shape = "Significance") +
  theme(plot.title = element_text(hjust = 0.5)) +
  scale_color_manual(values = pal1) +
...
##### Effect size graph - Probable Recurrent Major Depressive Disorder in sex and site-stratified samples
```{r Effect size graph MDD status - sex and site-stratified samples, echo=FALSE,  fig.height=50}

## split up dataframe by disorder and sex
res_CP_MDD_brain_structure_female_MDD_site <- res_CP_MDD_brain_structure_sex_site[res_CP_MDD_brain_structure_sex_site$disorder == "recurrent_depression" & res_CP_MDD_brain_structure_sex_site$sample == "Female",]
res_CP_MDD_brain_structure_male_MDD_site <- res_CP_MDD_brain_structure_sex_site[res_CP_MDD_brain_structure_sex_site$disorder == "recurrent_depression" & res_CP_MDD_brain_structure_sex_site$sample == "Male",]

## Order levels of brain phenotpyes in oder of beta values to make plot neat
res_CP_MDD_brain_structure_female_MDD_site$brain_phenotype_plot <- reorder(res_CP_MDD_brain_structure_female_MDD_site$brain_phenotype_plot, -res_CP_MDD_brain_structure_female_MDD_site$beta)
res_CP_MDD_brain_structure_male_MDD_site$brain_phenotype_plot <- reorder(res_CP_MDD_brain_structure_male_MDD_site$brain_phenotype_plot, -res_CP_MDD_brain_structure_male_MDD_site$beta)

## Plot resutls
brain_structure_gg = ggplot(res_CP_MDD_brain_structure_female_MDD_site, aes(x=brain_phenotype_plot, y=beta, shape=`Adjusted p-value`,colour=site)) + 
  geom_point(aes(y=beta),size=3, alpha = 0.5) +
  geom_errorbar(aes(ymin=Lower_95CI, ymax=Upper_95CI), width=0, alpha = 0.5) +
  theme_minimal() +
  geom_hline(yintercept=0, linetype="dashed", color = "black") +
  ...
  labs(x = "", 
       y = "Standardised effect size", 
       title = "Depression and brain structures in UK Biobank: site-stratified in female sample",
       colour = "Sex",
       shape = "Significance") +
  theme(plot.title = element_text(hjust = 0.5)) +
  scale_color_manual(values = pal1) +
...
brain_structure_gg = ggplot(res_CP_MDD_brain_structure_male_MDD_site, aes(x=brain_phenotype_plot, y=beta, shape=`Adjusted p-value`,colour=site)) + 
  geom_point(aes(y=beta),size=3, alpha = 0.5) +
  geom_errorbar(aes(ymin=Lower_95CI, ymax=Upper_95CI), width=0, alpha = 0.5) +
  theme_minimal() +
  geom_hline(yintercept=0, linetype="dashed", color = "black") +
  ...
  labs(x = "", 
       y = "Standardised effect size", 
       title = "Depression and brain structures in UK Biobank: site-stratified in male sample",
       colour = "Sex",
       shape = "Significance") +
  theme(plot.title = element_text(hjust = 0.5)) +
  scale_color_manual(values = pal1) +
