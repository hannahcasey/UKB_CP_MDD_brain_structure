...
res_comorbidity_brain_structure_noCP_noMDD$brain_structure_type_plot <- ordered(res_comorbidity_brain_structure_noCP_noMDD$brain_structure_type_plot , levels = c("Subcortical Volumes", "Cortical Regional\nVolumes","Cortical Volume\nGlobal and Lobal\nMeasures", "Cortical Regional\nAreas", "Cortical Area\nGlobal and Lobal\nMeasures", "Cortical Regional\nThickness","Cortical Thickness\nGlobal and Lobal\nMeasures", "FA Tracts", "MD Tracts","FA General Measures", "MD General Measures"))

res_comorbidity_brain_structure_CP_noMDD$brain_structure_type_plot <- ordered(res_comorbidity_brain_structure_CP_noMDD$brain_structure_type_plot , levels = c("Subcortical Volumes", "Cortical Regional\nVolumes","Cortical Volume\nGlobal and Lobal\nMeasures", "Cortical Regional\nAreas", "Cortical Area\nGlobal and Lobal\nMeasures", "Cortical Regional\nThickness","Cortical Thickness\nGlobal and Lobal\nMeasures", "FA Tracts", "MD Tracts","FA General Measures", "MD General Measures"))

res_comorbidity_brain_structure_noCP_MDD$brain_structure_type_plot <- ordered(res_comorbidity_brain_structure_noCP_MDD$brain_structure_type_plot , levels = c("Subcortical Volumes", "Cortical Regional\nVolumes","Cortical Volume\nGlobal and Lobal\nMeasures", "Cortical Regional\nAreas", "Cortical Area\nGlobal and Lobal\nMeasures", "Cortical Regional\nThickness","Cortical Thickness\nGlobal and Lobal\nMeasures", "FA Tracts", "MD Tracts","FA General Measures", "MD General Measures"))

res_comorbidity_brain_structure_CP_MDD$brain_structure_type_plot <- ordered(res_comorbidity_brain_structure_CP_MDD$brain_structure_type_plot , levels = c("Subcortical Volumes", "Cortical Regional\nVolumes","Cortical Volume\nGlobal and Lobal\nMeasures", "Cortical Regional\nAreas", "Cortical Area\nGlobal and Lobal\nMeasures", "Cortical Regional\nThickness","Cortical Thickness\nGlobal and Lobal\nMeasures", "FA Tracts", "MD Tracts","FA General Measures", "MD General Measures"))
