...
## Plot resutls
## Reference: CP+MDD-
plot_comorbidity_CP_noMDD = ggplot(res_comorbidity_brain_structure_noCP_noMDD, aes(x=brain_phenotype_plot, y=beta, shape=significant,colour=as.factor(groups))) +
