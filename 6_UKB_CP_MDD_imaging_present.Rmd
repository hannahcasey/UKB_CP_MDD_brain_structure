...
n_MD_all <- range(res_CP_MDD_brain_structure_all$n[res_CP_MDD_brain_structure_all$disorder == "recurrent_depression"])
...
n_MD_female <- range(res_CP_MDD_brain_structure_female$n[res_CP_MDD_brain_structure_female$disorder == "recurrent_depression"])
...
n_MD_male <- range(res_CP_MDD_brain_structure_male$n[res_CP_MDD_brain_structure_male$disorder == "recurrent_depression"])
...
cat(paste0("Female:"), n_MD_female, "\n")

cat(paste0("Male:"), n_MD_male, "\n\n")
```
