...
n_MDD_all <- range(res_CP_MDD_brain_structure_all$n[res_CP_MDD_brain_structure_all$disorder == "recurrent_depression"])
n_CP_all <- range(res_CP_MDD_brain_structure_all$n[res_CP_MDD_brain_structure_all$disorder == "chronic_pain"])
...
n_MDD_female <- range(res_CP_MDD_brain_structure_female$n[res_CP_MDD_brain_structure_female$disorder == "recurrent_depression"])
n_CP_female <- range(res_CP_MDD_brain_structure_female$n[res_CP_MDD_brain_structure_female$disorder == "chronic_pain"])
...
n_MDD_male <- range(res_CP_MDD_brain_structure_male$n[res_CP_MDD_brain_structure_male$disorder == "recurrent_depression"])
n_CP_male <- range(res_CP_MDD_brain_structure_male$n[res_CP_MDD_brain_structure_male$disorder == "chronic_pain"])
...
n_CPMDD_all <- range(res_comorbidity_brain_structure_all$n)
...
res_comorbidity_structure_sex_interaction_all$sample <- "Sex Interaction\n(Males - Females)"
...
n_CPMDD_female <- range(res_comorbidity_brain_structure_female$n)
...
n_CPMDD_male <- range(res_comorbidity_brain_structure_male$n)
...
res_CP_MDD_brain_structure$`P-value (adjusted/not adjusted*) < 0.05` = ifelse(res_CP_MDD_brain_structure$p.adjust < 0.05, "Yes","No")
...
rm(res_comorbidity_structure_sex_interaction_all)
rm(temp)
```
...
pal_continuous <- c("#D81B60","#1E88E5", "#FFC107" )
...
## Plot resutls
## Reference: CP+MDD-
plot_comorbidity_noCP_noMDD = ggplot(res_comorbidity_brain_structure_noCP_noMDD, aes(x=brain_phenotype_plot, y=beta, shape=significant,colour=as.factor(groups))) +
  ...
  labs(x = "",
       ...
       shape = "P-value (adjusted/not adjusted*) < 0.05") +
...
## Order samples
res_comorbidity_brain_structure_CP_MDD_plot$sample <- ordered(res_comorbidity_brain_structure_CP_MDD_plot$sample, levels = c("All\n", "Sex Interaction\n(Males - Females)", "Female\n", "Male\n"))
...
# 
# ggsave(
#   "~/Desktop/PhD/projects/UKB_CP_MDD_brain_structure/writeup/Brain_journal_submission/display_images/figure_5.pdf",
#   plot = plot_comorbidity_CP_MDD,
#   device = NULL,
#   path = NULL,
#   scale = 1,
#   width = 10,
...
res_CP_MDD_brain_structure_regional_cortical_volumes <- res_CP_MDD_brain_structure[(res_CP_MDD_brain_structure$brain_structure_type == "Cortical Regional Volume") & (res_CP_MDD_brain_structure$disorder == "chronic_pain"),]
...
res_CP_MDD_brain_structure_regional_cortical_volumes$regions_ggseg <- c(dk_cortical_regions, 
                                                                        rep("rostral anterior cingulate", 4),
                                                                        dk_cortical_regions)
...
res_CP_MDD_brain_structure_regional_cortical_volumes$group[(res_CP_MDD_brain_structure_regional_cortical_volumes$disorder == "chronic_pain") & (res_CP_MDD_brain_structure_regional_cortical_volumes$sample == "All\n")] <- "All\n"

res_CP_MDD_brain_structure_regional_cortical_volumes$group[(res_CP_MDD_brain_structure_regional_cortical_volumes$disorder == "chronic_pain") & (res_CP_MDD_brain_structure_regional_cortical_volumes$sample == "Sex Interaction\n(Males - Females)")] <- "Sex Interaction\n(Males - Females)"

res_CP_MDD_brain_structure_regional_cortical_volumes$group[(res_CP_MDD_brain_structure_regional_cortical_volumes$disorder == "chronic_pain") & (res_CP_MDD_brain_structure_regional_cortical_volumes$sample == "Female\n")] <- "Female\n"

res_CP_MDD_brain_structure_regional_cortical_volumes$group[(res_CP_MDD_brain_structure_regional_cortical_volumes$disorder == "chronic_pain") & (res_CP_MDD_brain_structure_regional_cortical_volumes$sample == "Male\n")] <- "Male\n"
...
## Order groups
regional_cortical_volumes_ggseg$groups <- ordered(regional_cortical_volumes_ggseg$groups, levels = c("All\n", "Sex Interaction\n(Males - Females)","Female\n", "Male\n"))
...
p1 <- regional_cortical_volumes_ggseg %>%
  ...
  scale_fill_gradient2(limits = c(-0.1, 0.1), low = 'blue', mid = 'white', high = 'red') +
  theme_void() + 
...
res_CP_MDD_brain_structure_regional_cortical_areas <- res_CP_MDD_brain_structure[(res_CP_MDD_brain_structure$brain_structure_type == "Cortical Regional Area") & (res_CP_MDD_brain_structure$disorder == "chronic_pain"),]

dk_cortical_regions <- dk$palette

## Remove "corpus callosum" and "temporal pole" as they are not availalbe on UKB
dk_cortical_regions <- names(dk_cortical_regions)[!names(dk_cortical_regions) %in% c("corpus callosum", "temporal pole")]
res_CP_MDD_brain_structure_regional_cortical_areas$regions_ggseg <- rep(dk_cortical_regions, 2)

## Compare name columns as sanity check
#res_CP_MDD_brain_structure_regional_cortical_areas[c("regions_ggseg", "brain_phenotype")]

## Create informative groups
res_CP_MDD_brain_structure_regional_cortical_areas$group[(res_CP_MDD_brain_structure_regional_cortical_areas$disorder == "chronic_pain") & (res_CP_MDD_brain_structure_regional_cortical_areas$sample == "All\n")] <- "All\n"

res_CP_MDD_brain_structure_regional_cortical_areas$group[(res_CP_MDD_brain_structure_regional_cortical_areas$disorder == "chronic_pain") & (res_CP_MDD_brain_structure_regional_cortical_areas$sample == "Sex Interaction\n(Males - Females)")] <- "Sex Interaction\n(Males - Females)"


# res_CP_MDD_brain_structure_regional_cortical_areas$group[(res_CP_MDD_brain_structure_regional_cortical_areas$disorder == "chronic_pain") & (res_CP_MDD_brain_structure_regional_cortical_areas$sample == "Female\n")] <- "Female\n"
# 
# res_CP_MDD_brain_structure_regional_cortical_areas$group[(res_CP_MDD_brain_structure_regional_cortical_areas$disorder == "chronic_pain") & (res_CP_MDD_brain_structure_regional_cortical_areas$sample == "Male\n")] <- "Male\n"
...
## Order groups
regional_cortical_areas_ggseg$groups <- ordered(regional_cortical_areas_ggseg$groups, levels = c("All\n", "Sex Interaction\n(Males - Females)","Female\n", "Male\n"))
...
res_CP_MDD_brain_structure_regional_cortical_thickness <- res_CP_MDD_brain_structure[(res_CP_MDD_brain_structure$brain_structure_type == "Cortical Regional Thickness") & (res_CP_MDD_brain_structure$disorder == "chronic_pain"),]

dk_cortical_regions <- dk$palette

## Check if any hemispheres have been analysed seperately 
seperate_hemispheres <- grep("right", res_CP_MDD_brain_structure_regional_cortical_thickness$brain_phenotype, value = T)

## Remove "corpus callosum" and "temporal pole" as they are not availalbe on UKB
dk_cortical_regions <- names(dk_cortical_regions)[!names(dk_cortical_regions) %in% c("corpus callosum", "temporal pole")]
## Remove "inferior temporal"
dk_cortical_regions_no_IT <- dk_cortical_regions[!dk_cortical_regions == "inferior temporal"]

res_CP_MDD_brain_structure_regional_cortical_thickness$regions_ggseg <- c(dk_cortical_regions_no_IT, 
                                                                          "inferior temporal", 
                                                                          "inferior temporal", 
...
## Create informative groups
res_CP_MDD_brain_structure_regional_cortical_thickness$group[(res_CP_MDD_brain_structure_regional_cortical_thickness$disorder == "chronic_pain") & (res_CP_MDD_brain_structure_regional_cortical_thickness$sample == "All\n")] <- "All\n"

res_CP_MDD_brain_structure_regional_cortical_thickness$group[(res_CP_MDD_brain_structure_regional_cortical_thickness$disorder == "chronic_pain") & (res_CP_MDD_brain_structure_regional_cortical_thickness$sample == "Sex Interaction\n(Males - Females)")] <- "Sex Interaction\n(Males - Females)"


res_CP_MDD_brain_structure_regional_cortical_thickness$group[(res_CP_MDD_brain_structure_regional_cortical_thickness$disorder == "chronic_pain") & (res_CP_MDD_brain_structure_regional_cortical_thickness$sample == "Female\n")] <- "Female\n"

res_CP_MDD_brain_structure_regional_cortical_thickness$group[(res_CP_MDD_brain_structure_regional_cortical_thickness$disorder == "chronic_pain") & (res_CP_MDD_brain_structure_regional_cortical_thickness$sample == "Male\n")] <- "Male\n"
...
## Order groups
regional_cortical_thickness_ggseg$groups <- ordered(regional_cortical_thickness_ggseg$groups, levels = c("All\n", "Sex Interaction\n(Males - Females)","Female\n", "Male\n"))
...
res_CP_MDD_brain_structure_regional_subcortical_volume <- res_CP_MDD_brain_structure[(res_CP_MDD_brain_structure$brain_structure_type == "Subcortical Volume") & (res_CP_MDD_brain_structure$disorder == "chronic_pain"),]

sub_cortical_regions <- c("thalamus proper","caudate", "putamen", "pallidum", "hippocampus", "amygdala", "accumbens area")

res_CP_MDD_brain_structure_regional_subcortical_volume$regions_ggseg <- c(sub_cortical_regions,
                                                                          "amygdala",
                                                                          "amygdala",
                                                                          "amygdala",
                                                                          sub_cortical_regions)

## Compare name columns as sanity check
#res_CP_MDD_brain_structure_regional_subcortical_volume[c("regions_ggseg", "brain_phenotype")]

## Create informative groups
res_CP_MDD_brain_structure_regional_subcortical_volume$group[(res_CP_MDD_brain_structure_regional_subcortical_volume$disorder == "chronic_pain") & (res_CP_MDD_brain_structure_regional_subcortical_volume$sample == "All\n")] <- "All\n"

res_CP_MDD_brain_structure_regional_subcortical_volume$group[(res_CP_MDD_brain_structure_regional_subcortical_volume$disorder == "chronic_pain") & (res_CP_MDD_brain_structure_regional_subcortical_volume$sample == "Sex Interaction\n(Males - Females)")] <- "Sex Interaction\n(Males - Females)"

res_CP_MDD_brain_structure_regional_subcortical_volume$group[(res_CP_MDD_brain_structure_regional_subcortical_volume$disorder == "chronic_pain") & (res_CP_MDD_brain_structure_regional_subcortical_volume$sample == "Female\n")] <- "Female\n"

res_CP_MDD_brain_structure_regional_subcortical_volume$group[(res_CP_MDD_brain_structure_regional_subcortical_volume$disorder == "chronic_pain") & (res_CP_MDD_brain_structure_regional_subcortical_volume$sample == "Male\n")] <- "Male\n"
...
## Order groups
regional_subcortical_volume_ggseg$groups <- ordered(regional_subcortical_volume_ggseg$groups, levels = c("All\n", "Sex Interaction\n(Males - Females)","Female\n", "Male\n"))
...
plot_CP <- (p1 / p2 / p3 / p4) + 
  ...
  theme(strip.text.x = element_text(size = 15), legend.text = element_text(size = 10), legend.title = element_text(size = 15), plot.tag = element_text(size = 10))
  
plot_CP
  
ggsave(
  "~/Desktop/PhD/projects/UKB_CP_MDD_brain_structure/writeup/Brain_journal_submission/display_images/figure_1.pdf",
  plot = plot_CP,
  device = NULL,
  path = NULL,
  scale = 1,
...
## Get only regional cortical volumes in chronic pain 
res_CP_MDD_brain_structure_regional_cortical_volumes <- res_CP_MDD_brain_structure[(res_CP_MDD_brain_structure$brain_structure_type == "Cortical Regional Volume") & (res_CP_MDD_brain_structure$disorder == "recurrent_depression"),]
...
## Remove "inferior temporal"
dk_cortical_regions_no_IP_ST_SM <- dk_cortical_regions[!dk_cortical_regions %in% c("inferior parietal", 
                                                                                   "superior temporal",
                                                                                   "supramarginal")]

res_CP_MDD_brain_structure_regional_cortical_volumes$regions_ggseg <- c(dk_cortical_regions_no_IP_ST_SM,
                                                                        rep(c("inferior parietal", "superior temporal", "supramarginal"), 2),
                                                                        "lateral occipital",
                                                                        "insula",
                                                                        "lateral occipital",
                                                                        "insula",
                                                                        dk_cortical_regions_no_IP_ST_SM,
                                                                        rep(c("inferior parietal", "superior temporal", "supramarginal"), 2)
                                                                        )
...
## Create informative groups
res_CP_MDD_brain_structure_regional_cortical_volumes$group[(res_CP_MDD_brain_structure_regional_cortical_volumes$disorder == "recurrent_depression") & (res_CP_MDD_brain_structure_regional_cortical_volumes$sample == "All\n")] <- "All\n"

res_CP_MDD_brain_structure_regional_cortical_volumes$group[(res_CP_MDD_brain_structure_regional_cortical_volumes$disorder == "recurrent_depression") & (res_CP_MDD_brain_structure_regional_cortical_volumes$sample == "Sex Interaction\n(Males - Females)")] <- "Sex Interaction\n(Males - Females)"

res_CP_MDD_brain_structure_regional_cortical_volumes$group[(res_CP_MDD_brain_structure_regional_cortical_volumes$disorder == "recurrent_depression") & (res_CP_MDD_brain_structure_regional_cortical_volumes$sample == "Female\n")] <- "Female\n"

res_CP_MDD_brain_structure_regional_cortical_volumes$group[(res_CP_MDD_brain_structure_regional_cortical_volumes$disorder == "recurrent_depression") & (res_CP_MDD_brain_structure_regional_cortical_volumes$sample == "Male\n")] <- "Male\n"
...
## Get only regional cortical areas in chronic pain 
res_CP_MDD_brain_structure_regional_cortical_areas <- res_CP_MDD_brain_structure[(res_CP_MDD_brain_structure$brain_structure_type == "Cortical Regional Area") & (res_CP_MDD_brain_structure$disorder == "recurrent_depression"),]
...
## Remove "inferior temporal"
dk_cortical_regions_no_IP<- dk_cortical_regions[!dk_cortical_regions %in% c("inferior parietal")]

res_CP_MDD_brain_structure_regional_cortical_areas$regions_ggseg <- c(dk_cortical_regions_no_IP,
                                                                      "inferior parietal", 
                                                                      "inferior parietal",
                                                                       rep("fusiform", 4),
                                                                       dk_cortical_regions_no_IP,
                                                                      "inferior parietal", 
                                                                      "inferior parietal")
...
## Create informative groups
res_CP_MDD_brain_structure_regional_cortical_areas$group[(res_CP_MDD_brain_structure_regional_cortical_areas$disorder == "recurrent_depression") & (res_CP_MDD_brain_structure_regional_cortical_areas$sample == "All\n")] <- "All\n"

res_CP_MDD_brain_structure_regional_cortical_areas$group[(res_CP_MDD_brain_structure_regional_cortical_areas$disorder == "recurrent_depression") & (res_CP_MDD_brain_structure_regional_cortical_areas$sample == "Sex Interaction\n(Males - Females)")] <- "Sex Interaction\n(Males - Females)"

res_CP_MDD_brain_structure_regional_cortical_areas$group[(res_CP_MDD_brain_structure_regional_cortical_areas$disorder == "recurrent_depression") & (res_CP_MDD_brain_structure_regional_cortical_areas$sample == "Female\n")] <- "Female\n"

res_CP_MDD_brain_structure_regional_cortical_areas$group[(res_CP_MDD_brain_structure_regional_cortical_areas$disorder == "recurrent_depression") & (res_CP_MDD_brain_structure_regional_cortical_areas$sample == "Male\n")] <- "Male\n"
...
## Get only regional cortical thickness in chronic pain 
res_CP_MDD_brain_structure_regional_cortical_thickness <- res_CP_MDD_brain_structure[(res_CP_MDD_brain_structure$brain_structure_type == "Cortical Regional Thickness") & (res_CP_MDD_brain_structure$disorder == "recurrent_depression"),]
...
res_CP_MDD_brain_structure_regional_cortical_thickness$regions_ggseg <- c(dk_cortical_regions,
                                                                       rep("lateral occipital", 2),
                                                                       dk_cortical_regions)
...
## Create informative groups
res_CP_MDD_brain_structure_regional_cortical_thickness$group[(res_CP_MDD_brain_structure_regional_cortical_thickness$disorder == "recurrent_depression") & (res_CP_MDD_brain_structure_regional_cortical_thickness$sample == "All\n")] <- "All\n"

res_CP_MDD_brain_structure_regional_cortical_thickness$group[(res_CP_MDD_brain_structure_regional_cortical_thickness$disorder == "recurrent_depression") & (res_CP_MDD_brain_structure_regional_cortical_thickness$sample == "Sex Interaction\n(Males - Females)")] <- "Sex Interaction\n(Males - Females)"

res_CP_MDD_brain_structure_regional_cortical_thickness$group[(res_CP_MDD_brain_structure_regional_cortical_thickness$disorder == "recurrent_depression") & (res_CP_MDD_brain_structure_regional_cortical_thickness$sample == "Female\n")] <- "Female\n"

res_CP_MDD_brain_structure_regional_cortical_thickness$group[(res_CP_MDD_brain_structure_regional_cortical_thickness$disorder == "recurrent_depression") & (res_CP_MDD_brain_structure_regional_cortical_thickness$sample == "Male\n")] <- "Male\n"
...
## Get only regional sub cortical volume
res_CP_MDD_brain_structure_regional_subcortical_volume <- res_CP_MDD_brain_structure[(res_CP_MDD_brain_structure$brain_structure_type == "Subcortical Volume") & (res_CP_MDD_brain_structure$disorder == "recurrent_depression"),]
...
## Create informative groups
res_CP_MDD_brain_structure_regional_subcortical_volume$group[(res_CP_MDD_brain_structure_regional_subcortical_volume$disorder == "recurrent_depression") & (res_CP_MDD_brain_structure_regional_subcortical_volume$sample == "All\n")] <- "All\n"

res_CP_MDD_brain_structure_regional_subcortical_volume$group[(res_CP_MDD_brain_structure_regional_subcortical_volume$disorder == "recurrent_depression") & (res_CP_MDD_brain_structure_regional_subcortical_volume$sample == "Sex Interaction\n(Males - Females)")] <- "Sex Interaction\n(Males - Females)"

res_CP_MDD_brain_structure_regional_subcortical_volume$group[(res_CP_MDD_brain_structure_regional_subcortical_volume$disorder == "recurrent_depression") & (res_CP_MDD_brain_structure_regional_subcortical_volume$sample == "Female\n")] <- "Female\n"

res_CP_MDD_brain_structure_regional_subcortical_volume$group[(res_CP_MDD_brain_structure_regional_subcortical_volume$disorder == "recurrent_depression") & (res_CP_MDD_brain_structure_regional_subcortical_volume$sample == "Male\n")] <- "Male\n"
...
ggsave(
  "~/Desktop/PhD/projects/UKB_CP_MDD_brain_structure/writeup/Brain_journal_submission/display_images/figure_3.pdf",
  plot = plot_MDD,
  device = NULL,
  path = NULL,
  scale = 1,
...
```{r Brain map legend, echo = FALSE, warning=FALSE}
## Make random plot to extract legend
mtcars$`Standardized β` <- sample(-100:100/100, nrow(mtcars))
random_plot <- ggplot(mtcars, aes(x=wt, y=mpg, color=`Standardized β`)) +
    geom_point() + 
    geom_smooth(method=lm, se=FALSE, fullrange=TRUE)+
  scale_color_gradient2(limits = c(-0.1, 0.1), low = 'blue', mid = 'white', high = 'red')
  
plot_range <- grid.draw(cowplot::get_legend(random_plot)) 

ggsave(
  "~/Desktop/PhD/projects/UKB_CP_MDD_brain_structure/writeup/Brain_journal_submission/display_images/plot_range.pdf",
  plot = plot_range,
  device = NULL,
  path = NULL,
  scale = 1,
...
```{r Sample sizes, echo = FALSE, warning=FALSE}
cat(paste0("Chronic Pain:\nAll:"), n_CP_all, "\n")

cat(paste0("Female:"), n_CP_female, "\n")

cat(paste0("Male:"), n_CP_male, "\n\n")

cat(paste0("Depression:\nAll:"), n_MDD_all, "\n")

cat(paste0("Female:"), n_MDD_female, "\n")

cat(paste0("Male:"), n_MDD_male, "\n\n")


cat(paste0("Comorbidity:\nAll:"), n_CPMDD_all, "\n")

cat(paste0("Female:"), n_CPMDD_female, "\n")

cat(paste0("Male:"), n_CPMDD_male, "\n\n")
```
...
<!-- ## Plot resutls -->
<!-- brain_structure_gg = ggplot(brain_structure_CP_all, aes(x=brain_phenotype_plot, y=beta, shape=`P-value (adjusted/not adjusted*) < 0.05`)) +  -->
...
<!-- ## Plot resutls -->
<!-- brain_structure_gg = ggplot(subset(res_CP_MDD_brain_structure[res_CP_MDD_brain_structure$disorder == "chronic_pain",], sample %in% c("Male", "Female", "All")), aes(x=brain_phenotype_plot, y=beta, shape=`P-value (adjusted/not adjusted*) < 0.05`,colour=sample)) +  -->
<!--   geom_point(aes(y=beta),size=3, alpha = 0.5) + -->
<!--   geom_errorbar(aes(ymin=Lower_95CI, ymax=Upper_95CI), width=0, alpha = 0.5) + -->
<!--   theme_minimal() + -->
<!--   geom_hline(yintercept=0, linetype="dashed", color = "black") + -->
...
<!-- brain_structure_gg = ggplot(brain_structure_MDD_all, aes(x=brain_phenotype_plot, y=beta, shape=`P-value (adjusted/not adjusted*) < 0.05`)) +  -->
<!--   geom_point(size=2) + -->
<!--   geom_errorbar(aes(ymin=Lower_95CI, ymax=Upper_95CI), width=0) + -->
<!--   theme_minimal() + -->
<!--   geom_hline(yintercept=0, linetype="dashed", color = "black") + -->
...
<!-- ## Plot resutls -->
<!-- brain_structure_gg = ggplot(subset(res_CP_MDD_brain_structure[res_CP_MDD_brain_structure$disorder == "recurrent_depression",], sample %in% c("Male", "Female", "All")), aes(x=brain_phenotype_plot, y=beta, shape=`P-value (adjusted/not adjusted*) < 0.05`,colour=sample)) +  -->
<!--   geom_point(aes(y=beta),size=3, alpha = 0.5) + -->
<!--   geom_errorbar(aes(ymin=Lower_95CI, ymax=Upper_95CI), width=0, alpha = 0.5) + -->
<!--   theme_minimal() + -->
<!--   geom_hline(yintercept=0, linetype="dashed", color = "black") + -->
...
<!-- brain_structure_gg = ggplot(res_CP_MDD_brain_structure_balanced_CP_f, aes(x=brain_phenotype_plot, y=beta, shape=`P-value (adjusted/not adjusted*) < 0.05`,colour=sample)) +  -->
<!--   geom_point(aes(y=beta),size=3, alpha = 0.5) + -->
<!--   geom_errorbar(aes(ymin=Lower_95CI, ymax=Upper_95CI), width=0, alpha = 0.5) + -->
<!--   theme_minimal() + -->
<!--   geom_hline(yintercept=0, linetype="dashed", color = "black") + -->
...
<!-- brain_structure_gg = ggplot(res_CP_MDD_brain_structure_balanced_CP_m, aes(x=brain_phenotype_plot, y=beta, shape=`P-value (adjusted/not adjusted*) < 0.05`,colour=sample)) +  -->
<!--   geom_point(aes(y=beta),size=3, alpha = 0.5) + -->
<!--   geom_errorbar(aes(ymin=Lower_95CI, ymax=Upper_95CI), width=0, alpha = 0.5) + -->
<!--   theme_minimal() + -->
<!--   geom_hline(yintercept=0, linetype="dashed", color = "black") + -->
...
<!-- brain_structure_gg = ggplot(res_CP_MDD_brain_structure_balanced_MDD_f, aes(x=brain_phenotype_plot, y=beta, shape=`P-value (adjusted/not adjusted*) < 0.05`,colour=sample)) +  -->
<!--   geom_point(aes(y=beta),size=3, alpha = 0.5) + -->
<!--   geom_errorbar(aes(ymin=Lower_95CI, ymax=Upper_95CI), width=0, alpha = 0.5) + -->
<!--   theme_minimal() + -->
<!--   geom_hline(yintercept=0, linetype="dashed", color = "black") + -->
...
<!-- brain_structure_gg = ggplot(res_CP_MDD_brain_structure_balanced_MDD_m, aes(x=brain_phenotype_plot, y=beta, shape=`P-value (adjusted/not adjusted*) < 0.05`,colour=sample)) +  -->
<!--   geom_point(aes(y=beta),size=3, alpha = 0.5) + -->
<!--   geom_errorbar(aes(ymin=Lower_95CI, ymax=Upper_95CI), width=0, alpha = 0.5) + -->
<!--   theme_minimal() + -->
<!--   geom_hline(yintercept=0, linetype="dashed", color = "black") + -->
...
<!-- sum(brain_structure_CP_all$`P-value (adjusted/not adjusted*) < 0.05` == "Yes") -->
<!-- sum(brain_structure_CP_female$`P-value (adjusted/not adjusted*) < 0.05` == "Yes") -->
<!-- sum(brain_structure_CP_male$`P-value (adjusted/not adjusted*) < 0.05` == "Yes") -->

<!-- sum(brain_structure_MDD_all$`P-value (adjusted/not adjusted*) < 0.05` == "Yes") -->
<!-- sum(brain_structure_MDD_female$`P-value (adjusted/not adjusted*) < 0.05` == "Yes") -->
<!-- sum(brain_structure_MDD_male$`P-value (adjusted/not adjusted*) < 0.05` == "Yes") -->
<!-- ``` -->
...
<!-- sum(brain_structure_CP_male$`P-value (adjusted/not adjusted*) < 0.05` == "Yes") -->
<!-- cat("Balanced CP:") -->
<!-- nrow(res_CP_MDD_brain_structure[(res_CP_MDD_brain_structure$sample == "Balanced:Female") & res_CP_MDD_brain_structure$disorder == "chronic_pain" & res_CP_MDD_brain_structure$`P-value (adjusted/not adjusted*) < 0.05` == "Yes",]) -->
<!-- nrow(res_CP_MDD_brain_structure[(res_CP_MDD_brain_structure$sample == "Balanced:Male") & res_CP_MDD_brain_structure$disorder == "chronic_pain" & res_CP_MDD_brain_structure$`P-value (adjusted/not adjusted*) < 0.05` == "Yes",]) -->
<!-- cat("Unbalanced MDD:") -->
<!-- sum(brain_structure_MDD_female$`P-value (adjusted/not adjusted*) < 0.05` == "Yes") -->
<!-- sum(brain_structure_MDD_male$`P-value (adjusted/not adjusted*) < 0.05` == "Yes") -->
<!-- cat("Balanced MDD:") -->
<!-- nrow(res_CP_MDD_brain_structure[(res_CP_MDD_brain_structure$sample == "Balanced:Female") & res_CP_MDD_brain_structure$disorder == "recurrent_depression" & res_CP_MDD_brain_structure$`P-value (adjusted/not adjusted*) < 0.05` == "Yes",]) -->
<!-- nrow(res_CP_MDD_brain_structure[(res_CP_MDD_brain_structure$sample == "Balanced:Male") & res_CP_MDD_brain_structure$disorder == "recurrent_depression" & res_CP_MDD_brain_structure$`P-value (adjusted/not adjusted*) < 0.05` == "Yes",]) -->
<!-- ``` -->
...
<!-- ggplot(brain_structure_MDD_all, aes(x = brain_structure_type, y = p.adjust.minus.log, colour =  brain_structure_type, shape = Direction, stroke = 1, fill = `P-value (adjusted/not adjusted*) < 0.05`)) + -->
...
<!-- plot_depression_females <- ggplot(brain_structure_MDD_female, aes(x = brain_structure_type, y = p.adjust.minus.log, colour =  brain_structure_type, shape = Direction, stroke = 1, fill = `P-value (adjusted/not adjusted*) < 0.05`)) + -->
<!--   scale_shape_manual(values=c(25, 24)) +  -->
<!--   scale_fill_manual(values = c("white", "dark grey")) + -->
<!--   geom_jitter(size = 2, position = position_jitter(seed = 151097)) + -->
<!--   geom_hline(yintercept=-log10(0.05), linetype="dashed",  -->
...
<!-- plot_depression_males <- ggplot(brain_structure_MDD_male, aes(x = brain_structure_type, y = p.adjust.minus.log, colour =  brain_structure_type, shape = Direction, stroke = 1, fill = `P-value (adjusted/not adjusted*) < 0.05`)) + -->
<!--   scale_shape_manual(values=c(25, 24)) +  -->
<!--   scale_fill_manual(values = c("white", "dark grey")) + -->
...
<!-- ggplot(brain_structure_CP_all, aes(x = brain_structure_type, y = p.adjust.minus.log, colour =  brain_structure_type, shape = Direction, stroke = 1, fill = `P-value (adjusted/not adjusted*) < 0.05`)) + -->
<!--   scale_shape_manual(values=c(25, 24)) +  -->
<!--   scale_fill_manual(values = c("white", "dark grey")) + -->
<!--   geom_jitter(size = 2, position = position_jitter(seed = 151097)) + -->
<!--   geom_hline(yintercept=-log10(0.05), linetype="dashed",  -->
...
<!-- plot_CP_females <- ggplot(brain_structure_CP_female, aes(x = brain_structure_type, y = p.adjust.minus.log, colour =  brain_structure_type, shape = Direction, stroke = 1, fill = `P-value (adjusted/not adjusted*) < 0.05`)) + -->
<!--   scale_shape_manual(values=c(25, 24)) +  -->
<!--   scale_fill_manual(values = c("white", "dark grey")) + -->
<!--   geom_jitter(size = 2, position = position_jitter(seed = 151097)) + -->
<!--   geom_hline(yintercept=-log10(0.05), linetype="dashed",  -->
...
<!-- plot_CP_males <- ggplot(brain_structure_CP_male, aes(x = brain_structure_type, y = p.adjust.minus.log, colour =  brain_structure_type, shape = Direction, stroke = 1, fill = `P-value (adjusted/not adjusted*) < 0.05`)) + -->
<!--   scale_shape_manual(values=c(25, 24)) +  -->
<!--   scale_fill_manual(values = c("white", "dark grey")) + -->
<!--   geom_jitter(size = 2, position = position_jitter(seed = 151097)) + -->
<!--   geom_hline(yintercept=-log10(0.05), linetype="dashed",  -->
