...
res_CP_MDD_brain_structure_regional_cortical_thickness$regions_ggseg <- c(dk_cortical_regions_no_IT, "inferior temporal", "inferior temporal", dk_cortical_regions_no_IT, "inferior temporal", "inferior temporal", dk_cortical_regions)
...
## Remove "corpus callosum" and "temporal pole" as they are not availalbe on UKB
dk_cortical_regions <- names(dk_cortical_regions)[!names(dk_cortical_regions) %in% c("corpus callosum", "temporal pole")]
## Get version without "bankssts", "fusiform", "rostral middle frontal"
dk_cortical_regions_males <- dk_cortical_regions[!dk_cortical_regions %in% c("bankssts", "fusiform", "rostral middle frontal")]
## Get version without "bankssts", "superior temporal", "supramarginal"
dk_cortical_regions_all <- dk_cortical_regions[!dk_cortical_regions %in% c("bankssts", "superior temporal", "supramarginal")]


res_CP_MDD_brain_structure_regional_cortical_volumes$regions_ggseg <- c(dk_cortical_regions_all, rep(c("bankssts", "superior temporal", "supramarginal"), 2),
                                                                        dk_cortical_regions,
                                                                        dk_cortical_regions_males, rep(c("bankssts", "fusiform", "rostral middle frontal"), 2)
                                                                        )
...
## Remove "corpus callosum" and "temporal pole" as they are not availalbe on UKB
dk_cortical_regions <- names(dk_cortical_regions)[!names(dk_cortical_regions) %in% c("corpus callosum", "temporal pole")]
## Remove "inferior parietal" and "inferior temporal" 
dk_cortical_regions_all <- dk_cortical_regions[!dk_cortical_regions %in% c("inferior parietal", "inferior temporal")]

res_CP_MDD_brain_structure_regional_cortical_areas$regions_ggseg <- c(dk_cortical_regions_all, rep(c("inferior parietal", "inferior temporal"), 2),
                                                                                                   dk_cortical_regions, dk_cortical_regions)
## Compare name columns as sanity check
#res_CP_MDD_brain_structure_regional_cortical_areas[c("regions_ggseg", "brain_phenotype")]
...
sum(brain_structure_CP_male$`Adjusted p-value < 0.05` == "Yes")
cat("Balanced CP:")
nrow(res_CP_MDD_brain_structure[(res_CP_MDD_brain_structure$sample == "Balanced:Female") & res_CP_MDD_brain_structure$disorder == "chronic_pain" & res_CP_MDD_brain_structure$`Adjusted p-value < 0.05` == "Yes",])
nrow(res_CP_MDD_brain_structure[(res_CP_MDD_brain_structure$sample == "Balanced:Male") & res_CP_MDD_brain_structure$disorder == "chronic_pain" & res_CP_MDD_brain_structure$`Adjusted p-value < 0.05` == "Yes",])
cat("Unbalanced MDD:")
sum(brain_structure_MDD_female$`Adjusted p-value < 0.05` == "Yes")
sum(brain_structure_MDD_male$`Adjusted p-value < 0.05` == "Yes")
cat("Balanced MDD:")
nrow(res_CP_MDD_brain_structure[(res_CP_MDD_brain_structure$sample == "Balanced:Female") & res_CP_MDD_brain_structure$disorder == "recurrent_depression" & res_CP_MDD_brain_structure$`Adjusted p-value < 0.05` == "Yes",])
nrow(res_CP_MDD_brain_structure[(res_CP_MDD_brain_structure$sample == "Balanced:Male") & res_CP_MDD_brain_structure$disorder == "recurrent_depression" & res_CP_MDD_brain_structure$`Adjusted p-value < 0.05` == "Yes",])
```
