   ...
   df_sex_interactions <- filter(CP_MDD_structure_sex_interaction_all, disorder == get("disorder", envir = .env))
    ...
    if (length(sig_sex_interaction_bilateral) > 0){
      ...
      cortical_volume_assoc <- data.frame()
        ...
        sig_sex_interaction_general <- cortical_volume_general[cortical_volume_general %in% unique(df_sex_interactions$brain_phenotype[df_sex_interactions$brain_structure_type == "Cortical Regional Volume" & df_sex_interactions$p < 0.05])]
    ...
    if (length(sig_sex_interaction_bilateral) > 0){
      ...
      cortical_thickness_assoc <- data.frame()
        ...
        sig_sex_interaction_general <- cortical_thickness_general[cortical_thickness_general %in% unique(df_sex_interactions$brain_phenotype[df_sex_interactions$brain_structure_type == "Cortical Regional Thickness" & df_sex_interactions$p < 0.05])]
    ...
    if (length(sig_sex_interaction_bilateral) > 0){
      ...
      cortical_area_assoc <- data.frame()
        ...
        sig_sex_interaction_general <- cortical_area_general[cortical_area_general %in% unique(df_sex_interactions$brain_phenotype[df_sex_interactions$brain_structure_type == "Cortical Regional Area" & df_sex_interactions$p < 0.05])]
...
for (sex in c("females", "males")){
  ...
  sig_sex_interaction_general <- cortical_volume_general[cortical_volume_general %in% unique(comorbidity_structure_sex_interaction_all$brain_phenotype[comorbidity_structure_sex_interaction_all$brain_structure_type == "Cortical Regional Volume" & comorbidity_structure_sex_interaction_all$p < 0.05])]
  ...
  sig_sex_interaction_general <- cortical_thickness_general[cortical_thickness_general %in% unique(comorbidity_structure_sex_interaction_all$brain_phenotype[comorbidity_structure_sex_interaction_all$brain_structure_type == "Cortical Regional Thickness" & comorbidity_structure_sex_interaction_all$p < 0.05])]
  ...
  sig_sex_interaction_general <- cortical_area_general[cortical_area_general %in% unique(comorbidity_structure_sex_interaction_all$brain_phenotype[comorbidity_structure_sex_interaction_all$brain_structure_type == "Cortical Regional Area" & comorbidity_structure_sex_interaction_all$p < 0.05])]
