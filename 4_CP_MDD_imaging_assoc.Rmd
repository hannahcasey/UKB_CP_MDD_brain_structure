...
# 
# write.csv(UKB_imaging_covariates, "/Users/hannahcasey/Desktop/UKB_imaging_covariates.csv")
#UKB_imaging_covariates <- read.csv("/Users/hannahcasey/Desktop/UKB_imaging_covariates.csv", header = TRUE)
...
#write.csv(UKB_imaging_covariates_long, "/Users/hannahcasey/Desktop/UKB_imaging_covariates_long.csv")
#UKB_imaging_covariates_long <- read.csv("/Users/hannahcasey/Desktop/UKB_imaging_covariates_long.csv", header = TRUE)
...
## Define functions to carry out hemisphere and sex interaction analysis, glm and lme analysis
...
hemisphere_interaction <- function(dependent, independent, covariates, dataset, hemisphere_col, structural_subtype){
...
## Functions to analyze sex interaction
bilateral_sex_interaction <- function(dependent, independent, sex_variable, covariates, dataset, hemisphere_col, id_col, structural_subtype){
  
  ## Input:
  ## dependent: names of dependent variables
  ## independent: name of independent variable
  ## sex_variable: name of sex variable
  ## covariates: array of covariates
  ## dataset: df contating data
  ## hemisphere_col: name of hemisphere column
  ## id_col: name of ID column
  ...
  for (i in dependent){
    ...
    ## Define formula
    mod <- paste0("",i,""," ~ ", independent, " + ", independent , ":", sex_variable, " + ", paste0(sex_variable, ":", c(covariates, hemisphere_col), collapse = "+"), " + (1 |" , id_col, ")")
    ...
    ## Extract output
    index <- grepl(paste0(disorder,":", sex_variable),rownames(summary(lme1)[["coefficients"]]))
...
unilateral_sex_interaction <- function(dependent, independent, sex_variable, covariates, dataset, structural_subtype){
  ...
  for (i in dependent){
    ...
    ## Define formula
    mod <- paste0(i," ~ ", independent, " + ", independent , ":", sex_variable, " + ", paste0(covariates, collapse = paste0(":", sex_variable, " + ")))
    ...
    ## Extract output
    index <- grepl(paste0(":", sex_variable),rownames(summary(glm1)[["coefficients"]]))
...
bilateral_sex_interaction_group <- function(dependent, independent, sex_variable, covariates, dataset, hemisphere_col, id_col, structural_subtype){
  ...
  for (i in dependent){
    ...
    ## Define formula
    mod <- paste0(i,""," ~ ", independent, " + ", independent , ":", sex_variable, " + ", paste0(c(covariates, hemisphere_col), collapse = paste0(":", sex_variable, " + ")), ":", sex_variable, " +(1 |" , id_col, ")")
    ...
    ## If significant between group difference found, carry out pairwise assoication
    if (anova1[paste0(independent, ":", sex_variable), "Pr(>F)"] < 0.05){
...
unilateral_sex_interaction_group <- function(dependent, independent, sex_variable, covariates, dataset, structural_subtype){
  ...
  for (i in dependent){
    ...
    ## Define formula
    mod <- paste0(i," ~ ", independent, " + ", independent , ":", sex_variable, " + ", paste0(covariates, collapse = paste0(":", sex_variable, " + ")), ":", sex_variable)
    ...
    ## If significant between group difference found, carry out pairwise assoication
    if (summary(anova1)[[1]][paste0(independent, ":", sex_variable), "Pr(>F)"] < 0.05){
...
for (disorder in c("chronic_pain", "recurrent_depression")){
  ...
  subcortical_volume_assoc <- bilateral_structure_assoc(dependent = sub_cortical_volume_bilateral[!sub_cortical_volume_bilateral %in% hemisphere_interactions],
    ...
    subcortical_volume_assoc <- rbind(subcortical_volume_assoc,
                                      unilateral_structure_assoc(dependent = c(paste0(hemisphere_interactions, "_right"), paste0(hemisphere_interactions, "_left")),
                                                                 independent = disorder,
                                                                 covariates = brain_structure_covariates_T1,
...
for (disorder in c("chronic_pain", "recurrent_depression")){
  ...
  subcortical_volume_sex_interaction <- bilateral_sex_interaction(dependent = sub_cortical_volume_bilateral[!sub_cortical_volume_bilateral %in% hemisphere_interactions],
                           independent = disorder,
                           sex_variable = "sex",
    ...
    subcortical_volume_sex_interaction <- rbind(subcortical_volume_sex_interaction,
                                      unilateral_sex_interaction(dependent = c(paste0(hemisphere_interactions, "_right"), paste0(hemisphere_interactions, "_left")),
                                                                 independent = disorder,
                                                                 sex_variable = "sex",
                                                                 covariates = brain_structure_covariates_T1_no_sex,
                                                                 dataset = UKB_CP_MDD_imaging_covariates,
  ...
  cortical_volume_sex_interaction <- bilateral_sex_interaction(dependent = cortical_volume_bilateral[!cortical_volume_bilateral %in% hemisphere_interactions],
                           independent = disorder,
                           sex_variable = "sex",
                           covariates = brain_structure_covariates_T1_no_sex,
                           dataset = UKB_CP_MDD_imaging_covariates_long,
  ...
  cortical_volume_general_sex_interaction <- unilateral_sex_interaction(dependent = cortical_volume_general,
                           independent = disorder,
                           sex_variable = "sex",
                           covariates = brain_structure_covariates_T1_no_sex,
                           dataset = UKB_CP_MDD_imaging_covariates,
  ...
  cortical_thickness_sex_interaction <- bilateral_sex_interaction(dependent = cortical_thickness_bilateral[!cortical_thickness_bilateral %in% hemisphere_interactions],
                           independent = disorder,
                           sex_variable = "sex",
                           covariates = brain_structure_covariates_T1_no_sex,
                           dataset = UKB_CP_MDD_imaging_covariates_long,
  ...
  cortical_thickness_general_sex_interaction <- unilateral_sex_interaction(dependent = cortical_thickness_general,
                           independent = disorder,
                           sex_variable = "sex",
                           covariates = brain_structure_covariates_T1_no_sex,
                           dataset = UKB_CP_MDD_imaging_covariates,
  ...
  cortical_area_sex_interaction <- bilateral_sex_interaction(dependent = cortical_area_bilateral[!cortical_area_bilateral %in% hemisphere_interactions],
                           independent = disorder,
                           sex_variable = "sex",
                           covariates = brain_structure_covariates_T1_no_sex,
                           dataset = UKB_CP_MDD_imaging_covariates_long,
  ...
  cortical_area_general_sex_interaction <- unilateral_sex_interaction(dependent = cortical_area_general,
                           independent = disorder,
                           sex_variable = "sex",
                           covariates = brain_structure_covariates_T1_no_sex,
                           dataset = UKB_CP_MDD_imaging_covariates,
  ...
  FA_bilateral_sex_interaction <- bilateral_sex_interaction(dependent = FA_bilateral[!FA_bilateral %in% hemisphere_interactions],
                           independent = disorder,
                           sex_variable = "sex",
  ...
  if (!is.null(hemisphere_interactions)){ ## If hemi interaction found, run separately
    ...
    FA_bilateral_sex_interaction <- rbind(FA_bilateral_sex_interaction,
                                      unilateral_sex_interaction(
                                        dependent = c(paste0(hemisphere_interactions, "_right"),
                                                      paste0(hemisphere_interactions, "_left")),
                                        independent = disorder,
  ...
  FA_unilateral_sex_interaction <- unilateral_sex_interaction(dependent = FA_unilateral,
                           independent = disorder,
                           sex_variable = "sex",
                           covariates = brain_structure_covariates_diffusion_no_sex,
                           dataset = UKB_CP_MDD_imaging_covariates,
  ...
  FA_general_sex_interaction <- unilateral_sex_interaction(dependent = FA_general,
                           independent = disorder,
                           sex_variable = "sex",
                           covariates = brain_structure_covariates_diffusion_no_sex,
                           dataset = UKB_CP_MDD_imaging_covariates,
  ...
  MD_bilateral_sex_interaction <- bilateral_sex_interaction(dependent = MD_bilateral[!MD_bilateral %in% hemisphere_interactions],
                           independent = disorder,
                           sex_variable = "sex",
                           covariates = brain_structure_covariates_diffusion_no_sex,
                           dataset = UKB_CP_MDD_imaging_covariates_long,
  ...
  if (!is.null(hemisphere_interactions)){ ## If hemi interaction found, run separately
    ...
    MD_bilateral_sex_interaction <- rbind(MD_bilateral_sex_interaction,
                                      unilateral_sex_interaction(
                                        dependent = c(paste0(hemisphere_interactions, "_right"),
                                                      paste0(hemisphere_interactions, "_left")),
                                        independent = disorder,
  ...
  MD_unilateral_sex_interaction <- unilateral_sex_interaction(dependent = MD_unilateral,
                           independent = disorder,
                           sex_variable = "sex",
                           covariates = brain_structure_covariates_diffusion_no_sex,
                           dataset = UKB_CP_MDD_imaging_covariates,
  ...
  MD_general_sex_interaction <- unilateral_sex_interaction(dependent = MD_general,
                           independent = disorder,
                           sex_variable = "sex",
                           covariates = brain_structure_covariates_diffusion_no_sex,
                           dataset = UKB_CP_MDD_imaging_covariates,
  ...
  ## Combine association results
  all_sex_interaction <- do.call("rbind", list(subcortical_volume_sex_interaction, cortical_volume_sex_interaction, cortical_area_sex_interaction, cortical_thickness_sex_interaction, cortical_area_general_sex_interaction, cortical_thickness_general_sex_interaction, cortical_volume_general_sex_interaction, FA_bilateral_sex_interaction, FA_general_sex_interaction, FA_unilateral_sex_interaction, MD_bilateral_sex_interaction, MD_general_sex_interaction, MD_unilateral_sex_interaction))
  ...
  paste(disorder, "and brain strucutre sex interaction association complete")
}
...
subcortical_volume_sex_interaction <- bilateral_sex_interaction_group(dependent = sub_cortical_volume_bilateral[!sub_cortical_volume_bilateral %in% hemisphere_interactions],
                         independent = "comorbidity_group",
                         sex_variable = "sex",
                         covariates = brain_structure_covariates_T1_no_sex,
                         dataset = UKB_CP_MDD_imaging_covariates_long,
...
if (!is.null(hemisphere_interactions)){ ## If hemi interaction found, run separately
  ...
  subcortical_volume_sex_interaction <- rbind(subcortical_volume_sex_interaction,
                                    unilateral_sex_interaction_group(
                                      dependent = c(paste0(hemisphere_interactions, "_right"), 
                                                    paste0(hemisphere_interactions, "_left")),
                                      independent = "comorbidity_group",
                                      sex_variable = "sex",
...
cortical_volume_sex_interaction <- bilateral_sex_interaction_group(dependent =  cortical_volume_bilateral[!cortical_volume_bilateral %in% hemisphere_interactions],
                         independent = "comorbidity_group",
                         sex_variable = "sex",
                         covariates = brain_structure_covariates_T1_no_sex,
                         dataset = UKB_CP_MDD_imaging_covariates_long,
...
cortical_volume_general_sex_interaction <- unilateral_sex_interaction_group(dependent = cortical_volume_general,
                                                                  independent = "comorbidity_group",
                                                                  covariates = brain_structure_covariates_T1_no_sex,
                                                                  sex_variable = "sex",
                                                                  dataset = UKB_CP_MDD_imaging_covariates,
...
cortical_thickness_sex_interaction <- bilateral_sex_interaction_group(dependent =  cortical_thickness_bilateral[!cortical_thickness_bilateral %in% hemisphere_interactions],
                         independent = "comorbidity_group",
                         sex_variable = "sex",
                         covariates = brain_structure_covariates_T1_no_sex,
                         dataset = UKB_CP_MDD_imaging_covariates_long,
...
cortical_thickness_general_sex_interaction <- unilateral_sex_interaction_group(dependent = cortical_thickness_general,
                                                                  independent = "comorbidity_group",
                                                                  covariates = brain_structure_covariates_T1_no_sex,
                                                                  sex_variable = "sex",
                                                                  dataset = UKB_CP_MDD_imaging_covariates,
...
cortical_area_sex_interaction <- bilateral_sex_interaction_group(dependent =  cortical_area_bilateral[!cortical_area_bilateral %in% hemisphere_interactions],
                         independent = "comorbidity_group",
                         sex_variable = "sex",
                         covariates = brain_structure_covariates_T1_no_sex,
                         dataset = UKB_CP_MDD_imaging_covariates_long,
...
cortical_area_general_sex_interaction <- unilateral_sex_interaction_group(dependent = cortical_area_general,
                                                                  independent = "comorbidity_group",
                                                                  covariates = brain_structure_covariates_T1_no_sex,
                                                                  sex_variable = "sex",
                                                                  dataset = UKB_CP_MDD_imaging_covariates,
...
FA_bilateral_sex_interaction <- bilateral_sex_interaction_group(dependent = FA_bilateral[!FA_bilateral %in% hemisphere_interactions],
                         independent = "comorbidity_group",
                         covariates = brain_structure_covariates_diffusion_no_sex,
                         sex_variable = "sex",
                         dataset = UKB_CP_MDD_imaging_covariates_long,
...
FA_unilateral_sex_interaction <- unilateral_sex_interaction_group(dependent = FA_unilateral,
                         independent = "comorbidity_group",
                         sex_variable = "sex",
                         covariates = brain_structure_covariates_diffusion_no_sex,
                         dataset = UKB_CP_MDD_imaging_covariates,
...
FA_general_sex_interaction <- unilateral_sex_interaction_group(dependent = FA_general,
                         independent = "comorbidity_group",
                         sex_variable = "sex",
                         covariates = brain_structure_covariates_diffusion_no_sex,
                         dataset = UKB_CP_MDD_imaging_covariates,
...
MD_bilateral_sex_interaction <- bilateral_sex_interaction_group(dependent = MD_bilateral[!MD_bilateral %in% hemisphere_interactions],
                         independent = "comorbidity_group",
                         covariates = brain_structure_covariates_diffusion_no_sex,
                         sex_variable = "sex",
                         dataset = UKB_CP_MDD_imaging_covariates_long,
...
MD_unilateral_sex_interaction <- unilateral_sex_interaction_group(dependent = MD_unilateral,
                         independent = "comorbidity_group",
                         sex_variable = "sex",
                         covariates = brain_structure_covariates_diffusion_no_sex,
                         dataset = UKB_CP_MDD_imaging_covariates,
...
MD_general_sex_interaction <- unilateral_sex_interaction_group(dependent = MD_general,
                         independent = "comorbidity_group",
                         sex_variable = "sex",
                         covariates = brain_structure_covariates_diffusion_no_sex,
                         dataset = UKB_CP_MDD_imaging_covariates,
...
for (sex in c("females", "males")){
  for (disorder in c("chronic_pain", "recurrent_depression")){
   ...
   df_sex_interactions <- filter(CP_MDD_structure_sex_interaction_all, disorder == get("disorder", envir = .env))
    ...
    ##Subcortical Volume ----
    sig_sex_interaction_bilateral <- unique(df_sex_interactions$brain_phenotype[df_sex_interactions$brain_structure_type == "Subcortical Volume" & df_sex_interactions$p < 0.05])
    
    if (length(sig_sex_interaction_bilateral) > 0){
    ## flag if any bilateral hemisphere measurements need to be analyzed separately
    hemisphere_interactions <- hemisphere_interaction(dependent = sig_sex_interaction_bilateral,
                           independent = disorder,
                           covariates = brain_structure_covariates_T1_no_sex,
    ...
    if(!all(sig_sex_interaction_bilateral %in% hemisphere_interactions)){
      ...
      subcortical_volume_assoc <- bilateral_structure_assoc(dependent = sig_sex_interaction_bilateral[!sig_sex_interaction_bilateral %in% hemisphere_interactions],
                               independent = disorder,
                               covariates = brain_structure_covariates_T1_no_sex,
                               dataset = get(paste0("UKB_CP_MDD_imaging_covariates_long_",sex)),
                               n_comparisons = length(sub_cortical_volume_bilateral[!sub_cortical_volume_bilateral %in% hemisphere_interactions]) + (length(hemisphere_interactions) * 2),
    ...
    sig_sex_interaction_bilateral <- cortical_volume_bilateral[cortical_volume_bilateral %in% unique(df_sex_interactions$brain_phenotype[df_sex_interactions$brain_structure_type == "Cortical Regional Volume" & df_sex_interactions$p < 0.05])]
    ...
    if (length(sig_sex_interaction_bilateral) > 0){
      ...
      if(!all(sig_sex_interaction_bilateral %in% hemisphere_interactions)){
        ...
        cortical_volume_assoc <- bilateral_structure_assoc(dependent = sig_sex_interaction_bilateral[!sig_sex_interaction_bilateral %in% hemisphere_interactions],
                                 independent = disorder,
                                 covariates = brain_structure_covariates_T1_no_sex,
                                 dataset = get(paste0("UKB_CP_MDD_imaging_covariates_long_",sex)),
      ...
      cortical_volume_assoc <- data.frame()
        ...
        sig_sex_interaction_general <- cortical_volume_general[cortical_volume_general %in% unique(df_sex_interactions$brain_phenotype[df_sex_interactions$brain_structure_type == "Cortical Volume Global and Lobal Measures" & df_sex_interactions$p < 0.05])]
    
    if (length(sig_sex_interaction_general) > 0){
      
      cortical_volume_general_assoc <- unilateral_structure_assoc(dependent = sig_sex_interaction_general,
                               independent = disorder,
                               covariates = brain_structure_covariates_T1_no_sex,
                               dataset = get(paste0("UKB_CP_MDD_imaging_covariates_",sex)),
    ...
    sig_sex_interaction_bilateral <- cortical_thickness_bilateral[cortical_thickness_bilateral %in% unique(df_sex_interactions$brain_phenotype[df_sex_interactions$brain_structure_type == "Cortical Regional Thickness" & df_sex_interactions$p < 0.05])]
    ...
    if (length(sig_sex_interaction_bilateral) > 0){
      ...
      cortical_thickness_assoc <- bilateral_structure_assoc(dependent = sig_sex_interaction_bilateral[!sig_sex_interaction_bilateral %in% hemisphere_interactions],
                               independent = disorder,
                               covariates = brain_structure_covariates_T1_no_sex,
                               dataset = get(paste0("UKB_CP_MDD_imaging_covariates_long_",sex)),
                               n_comparisons = length(sig_sex_interaction_bilateral[!sig_sex_interaction_bilateral %in% hemisphere_interactions]) + (length(hemisphere_interactions) * 2),
      ...
      cortical_thickness_assoc <- data.frame()
        ...
        sig_sex_interaction_general <- cortical_thickness_general[cortical_thickness_general %in% unique(df_sex_interactions$brain_phenotype[df_sex_interactions$brain_structure_type == "Cortical Thickness Global and Lobal Measures" & df_sex_interactions$p < 0.05])]
    
    if (length(sig_sex_interaction_general) > 0){
      
      cortical_thickness_general_assoc <- unilateral_structure_assoc(dependent = sig_sex_interaction_general,
                               independent = disorder,
                               covariates = brain_structure_covariates_T1_no_sex,
                               dataset = get(paste0("UKB_CP_MDD_imaging_covariates_",sex)),
                               n_comparisons = length(sig_sex_interaction_general),
    ...
    sig_sex_interaction_bilateral <- cortical_area_bilateral[cortical_area_bilateral %in% unique(df_sex_interactions$brain_phenotype[df_sex_interactions$brain_structure_type == "Cortical Regional Area" & df_sex_interactions$p < 0.05])]
    ...
    if (length(sig_sex_interaction_bilateral) > 0){
      ...
      cortical_area_assoc <- data.frame()
        ...
        sig_sex_interaction_general <- cortical_area_general[cortical_area_general %in% unique(df_sex_interactions$brain_phenotype[df_sex_interactions$brain_structure_type == "Cortical Area Global and Lobal Measures" & df_sex_interactions$p < 0.05])]
    
    if (length(sig_sex_interaction_general) > 0){
      
      cortical_area_general_assoc <- unilateral_structure_assoc(dependent = sig_sex_interaction_general,
                               independent = disorder,
                               covariates = brain_structure_covariates_T1_no_sex,
                               dataset = get(paste0("UKB_CP_MDD_imaging_covariates_",sex)),
                               n_comparisons = length(sig_sex_interaction_general),
      ...
      cortical_area_general_assoc <- data.frame()
        ...
        sig_sex_interaction_bilateral <- FA_bilateral[FA_bilateral %in% unique(df_sex_interactions$brain_phenotype[df_sex_interactions$brain_structure_type == "FA Tracts" & df_sex_interactions$p < 0.05])]
      ...
      if(!all(sig_sex_interaction_bilateral %in% hemisphere_interactions)){
        ...
        FA_bilateral_assoc <- bilateral_structure_assoc(dependent = sig_sex_interaction_bilateral[!sig_sex_interaction_bilateral %in% hemisphere_interactions],
                                                        independent = disorder,
                                                         covariates = brain_structure_covariates_diffusion_no_sex,
                                                         dataset = get(paste0("UKB_CP_MDD_imaging_covariates_long_",sex)),
                                                         n_comparisons = length(sig_sex_interaction_bilateral[!sig_sex_interaction_bilateral %in% hemisphere_interactions]) + (length(hemisphere_interactions) * 2),
        ...
        sig_sex_interaction_unilateral <- FA_unilateral[FA_unilateral %in% unique(df_sex_interactions$brain_phenotype[df_sex_interactions$brain_structure_type == "FA Tracts" & df_sex_interactions$p < 0.05])]
    
    if (length(sig_sex_interaction_unilateral) > 0){

      FA_unilateral_assoc <- unilateral_structure_assoc(dependent = sig_sex_interaction_unilateral,
                             independent = disorder,
                             covariates = brain_structure_covariates_diffusion_no_sex,
                             dataset = get(paste0("UKB_CP_MDD_imaging_covariates_",sex)),
        ...
        sig_sex_interaction_general <- FA_general[FA_general %in% unique(df_sex_interactions$brain_phenotype[df_sex_interactions$brain_structure_type == "FA Tracts" & df_sex_interactions$p < 0.05])]
    
    if (length(sig_sex_interaction_general) > 0){

    FA_general_assoc <- unilateral_structure_assoc(dependent = sig_sex_interaction_general,
                             independent = disorder,
                             covariates = brain_structure_covariates_diffusion_no_sex,
                             dataset = get(paste0("UKB_CP_MDD_imaging_covariates_",sex)),
                             n_comparisons = sig_sex_interaction_general,
                             structural_subtype = "FA General Measures")
        ...
        sig_sex_interaction_bilateral <- MD_bilateral[MD_bilateral %in% unique(df_sex_interactions$brain_phenotype[df_sex_interactions$brain_structure_type == "MD Tracts" & df_sex_interactions$p < 0.05])]
      ...
      if(!all(sig_sex_interaction_bilateral %in% hemisphere_interactions)){
        ...
        MD_bilateral_assoc <- bilateral_structure_assoc(dependent = sig_sex_interaction_bilateral[!sig_sex_interaction_bilateral %in% hemisphere_interactions],
                                                        independent = disorder,
                                                         covariates = brain_structure_covariates_diffusion_no_sex,
                                                         dataset = get(paste0("UKB_CP_MDD_imaging_covariates_long_",sex)),
                                                         n_comparisons = length(sig_sex_interaction_bilateral[!sig_sex_interaction_bilateral %in% hemisphere_interactions]) + (length(hemisphere_interactions) * 2),
        ...
        sig_sex_interaction_unilateral <- MD_unilateral[MD_unilateral %in% unique(df_sex_interactions$brain_phenotype[df_sex_interactions$brain_structure_type == "MD Tracts" & df_sex_interactions$p < 0.05])]
    
    if (length(sig_sex_interaction_unilateral) > 0){

      MD_unilateral_assoc <- unilateral_structure_assoc(dependent = sig_sex_interaction_unilateral,
                             independent = disorder,
                             covariates = brain_structure_covariates_diffusion_no_sex,
                             dataset = get(paste0("UKB_CP_MDD_imaging_covariates_",sex)),
                             n_comparisons = length(sig_sex_interaction_unilateral),
        ...
        sig_sex_interaction_general <- MD_general[MD_general %in% unique(df_sex_interactions$brain_phenotype[df_sex_interactions$brain_structure_type == "MD Tracts" & df_sex_interactions$p < 0.05])]
    
    if (length(sig_sex_interaction_general) > 0){

    MD_general_assoc <- unilateral_structure_assoc(dependent = sig_sex_interaction_general,
                             independent = disorder,
                             covariates = brain_structure_covariates_diffusion_no_sex,
                             dataset = get(paste0("UKB_CP_MDD_imaging_covariates_",sex)),
                             n_comparisons = sig_sex_interaction_general,
...
for (sex in c("females", "males")){
  ...
  sig_sex_interaction_bilateral <- unique(comorbidity_structure_sex_interaction_all$brain_phenotype[comorbidity_structure_sex_interaction_all$brain_structure_type == "Subcortical Volume" & comorbidity_structure_sex_interaction_all$p < 0.05])
  ...
  sig_sex_interaction_bilateral <- cortical_volume_bilateral[cortical_volume_bilateral %in% unique(comorbidity_structure_sex_interaction_all$brain_phenotype[comorbidity_structure_sex_interaction_all$brain_structure_type == "Cortical Regional Volume" & comorbidity_structure_sex_interaction_all$p < 0.05])]
  ...
  sig_sex_interaction_general <- cortical_volume_general[cortical_volume_general %in% unique(comorbidity_structure_sex_interaction_all$brain_phenotype[comorbidity_structure_sex_interaction_all$brain_structure_type == "Cortical Volume Global and Lobal Measures" & comorbidity_structure_sex_interaction_all$p < 0.05])]
  ...
  sig_sex_interaction_bilateral <- cortical_thickness_bilateral[cortical_thickness_bilateral %in% unique(comorbidity_structure_sex_interaction_all$brain_phenotype[comorbidity_structure_sex_interaction_all$brain_structure_type == "Cortical Regional Thickness" & comorbidity_structure_sex_interaction_all$p < 0.05])]
  ...
  sig_sex_interaction_general <- cortical_thickness_general[cortical_thickness_general %in% unique(comorbidity_structure_sex_interaction_all$brain_phenotype[comorbidity_structure_sex_interaction_all$brain_structure_type == "Cortical Thickness Global and Lobal Measures" & comorbidity_structure_sex_interaction_all$p < 0.05])]
  ...
  cortical_thickness_general_assoc <- unilateral_structure_assoc_group(
   ...
   ## Cortical Area ----
  sig_sex_interaction_bilateral <- cortical_area_bilateral[cortical_area_bilateral %in% unique(comorbidity_structure_sex_interaction_all$brain_phenotype[comorbidity_structure_sex_interaction_all$brain_structure_type == "Cortical Regional Area" & comorbidity_structure_sex_interaction_all$p < 0.05])]
  ...
  sig_sex_interaction_general <- cortical_area_general[cortical_area_general %in% unique(comorbidity_structure_sex_interaction_all$brain_phenotype[comorbidity_structure_sex_interaction_all$brain_structure_type == "Cortical Area Global and Lobal Measures" & comorbidity_structure_sex_interaction_all$p < 0.05])]
  ...
  sig_sex_interaction_bilateral <- FA_bilateral[FA_bilateral %in% unique(comorbidity_structure_sex_interaction_all$brain_phenotype[comorbidity_structure_sex_interaction_all$brain_structure_type == "FA Tracts" & comorbidity_structure_sex_interaction_all$p < 0.05])]
  ...
  sig_sex_interaction_unilateral <- FA_unilateral[FA_unilateral %in% unique(comorbidity_structure_sex_interaction_all$brain_phenotype[comorbidity_structure_sex_interaction_all$brain_structure_type == "FA Tracts" & comorbidity_structure_sex_interaction_all$p < 0.05])]
  ...
  sig_sex_interaction_general <- FA_general[FA_general %in% unique(comorbidity_structure_sex_interaction_all$brain_phenotype[comorbidity_structure_sex_interaction_all$brain_structure_type == "FA Tracts" & comorbidity_structure_sex_interaction_all$p < 0.05])]
  ...
  sig_sex_interaction_bilateral <- MD_bilateral[MD_bilateral %in% unique(comorbidity_structure_sex_interaction_all$brain_phenotype[comorbidity_structure_sex_interaction_all$brain_structure_type == "MD Tracts" & comorbidity_structure_sex_interaction_all$p < 0.05])]
  ...
  sig_sex_interaction_unilateral <- MD_unilateral[MD_unilateral %in% unique(comorbidity_structure_sex_interaction_all$brain_phenotype[comorbidity_structure_sex_interaction_all$brain_structure_type == "MD Tracts" & comorbidity_structure_sex_interaction_all$p < 0.05])]
  ...
  sig_sex_interaction_general <- MD_general[MD_general %in% unique(comorbidity_structure_sex_interaction_all$brain_phenotype[comorbidity_structure_sex_interaction_all$brain_structure_type == "MD Tracts" & comorbidity_structure_sex_interaction_all$p < 0.05])]
...
comorbidity_structure_assoc_females$p.adjust[comorbidity_structure_assoc_females$brain_structure_type == "Cortical Regional Thickness"] <- p.adjust(comorbidity_structure_assoc_females$p.value[comorbidity_structure_assoc_females$brain_structure_type == "Cortical Regional Thickness"], method = "fdr")

comorbidity_structure_assoc_females$p.adjust[comorbidity_structure_assoc_females$brain_structure_type == "Cortical Regional Volume"] <- p.adjust(comorbidity_structure_assoc_females$p.value[comorbidity_structure_assoc_females$brain_structure_type == "Cortical Regional Volume"], method = "fdr")
...
write.csv(comorbidity_structure_sex_interaction_all, paste0(work_dir,"output/comorbidity_structure_sex_interaction_all.csv"), quote = FALSE, row.names = FALSE)
