...
write.csv(UKB_imaging_covariates, "/Volumes/GenScotDepression/users/hcasey/UKB_brain_structure_CP_MDD/UKB_imaging_covariates.csv", quote = F)
write.csv(UKB_imaging_covariates_long, "~/Volumes/GenScotDepression/users/hcasey/UKB_brain_structure_CP_MDD/UKB_imaging_covariates_long.csv", quote = F)
```
