...
write.csv(DTI_VE_df, "/output/DTI_PCA_variance_explained.csv", row.names = F)
...
write.csv(as.data.frame(DTI_outlier_ids), "/resources/DTI_imaging_outliers.csv", quote = F)
write.csv(as.data.frame(T1_outlier_ids), "/resources/T1_imaging_outliers.csv", quote = F)
write.csv(as.data.frame(outlier_ids), "/resources/imaging_outliers.csv", quote = F)
```
...
write.csv(UKB_imaging_covariates, "/resources/UKB_imaging_covariates_qc.csv", quote = F)
write.csv(UKB_imaging_covariates_long, "/resources/UKB_imaging_covariates_long_qc.csv", quote = F)
```
