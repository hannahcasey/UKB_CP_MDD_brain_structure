...
UKB_imaging_covariates[,c(all_brain_structure_names, "ICV", "X_position", "Y_position", "Z_position")] <- as.data.frame(scale(UKB_imaging_covariates[,c(all_brain_structure_names, "ICV", "X_position", "Y_position", "Z_position")]))
```
