...
unilateral_structure_assoc_group <- function(dependent, independent, covariates, dataset, n_comparisons, structural_subtype){
  ...
  ## Create dataframe to store association analysis output
  output <-  data.frame(groups=character(), beta=numeric(), std=numeric(), p.value=numeric(),
                                             p.adjust=numeric(), Lower_95CI=numeric(), Upper_95CI=numeric(), n=numeric())
...
for (site in c("Newcastle" ,"Cheadle", "Reading")){
  ...
  ## Add column indicating methylation score p-value threshold
  all_CP_MDD_structure_assoc_males$site <- site
  all_CP_MDD_structure_assoc_females$site <- site
      
  if (site == "Newcastle"){
    assign("all_CP_MDD_structure_assoc_males_site", all_CP_MDD_structure_assoc_males)
    assign("all_CP_MDD_structure_assoc_females_site", all_CP_MDD_structure_assoc_females)    
  }else{
    assign("all_CP_MDD_structure_assoc_males_site" , rbind(all_CP_MDD_structure_assoc_males_site, all_CP_MDD_structure_assoc_males))
    assign("all_CP_MDD_structure_assoc_females_site", rbind(all_CP_MDD_structure_assoc_females_site, all_CP_MDD_structure_assoc_females))
  }
